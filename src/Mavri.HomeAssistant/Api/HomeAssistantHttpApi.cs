...
public class HomeAssistantHttpApi : IDisposable
{
	...
	public async Task CallService(string domain, string service, object data, CancellationToken ct)
	{
		var content = data == null
			? null
			: new StringContent(JsonSerializer.Serialize(data, HomeAssistantWebSocketApi.JsonWriteOpts), Encoding.UTF8, "application/json");
